...
public class DriveService {
	...
	public static List<FileDrive> doSearch(String name) {
		// TODO Auto-generated method stub
		List<FileDrive> fileDrives = new ArrayList<FileDrive>();
		...
		try {
			...
			do {
				...
				for (File file : result.getFiles()) {
					fileDrive.name = file.getMimeType();
					fileDrive.link = file.getWebViewLink();
					fileDrives.add(fileDrive);
				}
